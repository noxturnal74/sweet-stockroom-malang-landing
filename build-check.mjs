...
if (!js.includes("requestAnimationFrame") || !js.includes('motionProfile = "sweet"') || !html.includes('data-motion-profile="sweet"')) {
...
console.log("Sweet Stockroom brand-DNA build check passed.");
